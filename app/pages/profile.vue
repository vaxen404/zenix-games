                ...
                <div class="profile-card">
                    ...
                    <div class="profile-details">
                        <div class="details-row">
                            <span class="details-label">Kullanıcı Adı</span>
                            <span class="details-value">@{{ userDetails.username }}</span>
                        </div>

                        <div class="details-row">
                            <span class="details-label">Email Adresi</span>
                            <span class="details-value">{{ userDetails.email }}</span>
                        </div>

                        <div class="details-row">
                            <span class="details-label">Katılma Tarihi</span>
                            <span class="details-value">{{ userDetails.created_at }}</span>
                        </div>
                    </div>
                </div>
            </main>
